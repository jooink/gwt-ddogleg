...
public class ExampleNearestNeighbor {
	...
	static Logger lg=Logger.getLogger(ExampleNearestNeighbor.class.getName());
	...
	public static void init() {
		...
		if( nn.findNearest(new double[]{1.1,2.2},-1,result) ) {
			lg.log(Level.INFO,"Best match:");
			lg.log(Level.INFO,"   point     = "+result.point[0]+" "+result.point[1]);
			lg.log(Level.INFO,"   data      = "+result.data);
			lg.log(Level.INFO,"   distance  = "+result.distance);
			...
			lg.log(Level.INFO,"No match found");
