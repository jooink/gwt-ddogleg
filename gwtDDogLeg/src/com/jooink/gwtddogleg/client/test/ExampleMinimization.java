...
public class ExampleMinimization {
	...
	static Logger lg=Logger.getLogger(ExampleMinimization.class.getName());
	...
	public static void init() {
		...
		lg.log(Level.INFO,"Final Error = "+optimizer.getFunctionValue());
		//System.out.println("Final Error = "+optimizer.getFunctionValue());

		// Compare the actual parameters to the found parameters
		lg.log(Level.INFO,"Actual "+lineX+"  found "+found[0]);
		lg.log(Level.INFO,"Actual "+lineY+"  found "+found[1]);
	}
}
